...
## 44. 매개변수 실습
참조선 생성
![5th_TIL44(1)](./img/5th_TIL44(1).png)

목표 매출 달성/미달성 국가 색상 구분
![5th_TIL44(2)](./img/5th_TIL44(2).png)| ![5th_TIL44(3)](./img/5th_TIL44(3).png)
--| --|

그래프에서 시작 날짜와 마지막 날자 선택 -> 해당 범위 매출 합계 표시하기
![5th_TIL44(4)](./img/5th_TIL44(4).png)
→ 매개 변수 표시

![5th_TIL44(5)](./img/5th_TIL44(5).png)
분석 → 참조 구간 → 테이블

해당 날짜 범위에 매출 합계를 그래프 제목에 나타내기
![5th_TIL44(6)](./img/5th_TIL44(6).png)→ 매출 합계| ![5th_TIL44(7)](./img/5th_TIL44(7).png)→ '날짜 범위에 매출 합계'를 마크 카드 세부정보에 드래그&드랍
--| --|

![5th_TIL44(8)](./img/5th_TIL44(8).png)

## 45. 워크시트 마크카드

<!-- 마크카드에 대해 알게 된 점을 적어주세요 -->
![5th_TIL45(4)](./img/5th_TIL45(4).png)
후광 옵션: 디자인 요소
필드 → 색상으로 드래그&드랍: 필드에 따라 마크들이 색상으로 구분
    연속형 필드: 색상 범위 범례
    불연속형 필드: 항목별 범례(사용자가 색상 지정 가능)
마크 크기 조정 가능

![5th_TIL45(1)](./img/5th_TIL45(1).png)
레이블에 필드 드래그&드랍 → 레이블 원하는 형식으로 편집
폰트, 색상, 크기, 방향, 위치 변경가능

![5th_TIL45(2)](./img/5th_TIL45(2).png)라인 차트: 라인 유형 변경| ![5th_TIL45(3)](./img/5th_TIL45(3).png)원 차트: 마크 모양 변경
--| --|

## 46. 서식 계층
서식 계층에서 상위 계층에 서식을 설정했을 때 상위 계층보다 아래 계층인 경우에 서식을 변경하게 되면 해당 아래 계층에 설정한 서식이 적용됨
<!-- 서식계층에 대해 알게 된 점을 적어주세요 -->

![5th_TIL46(1)](./img/5th_TIL46(1).png)| ![5th_TIL46(2)](./img/5th_TIL46(2).png)
--| --|

![5th_TIL46(3)](./img/5th_TIL46(3).png)| ![5th_TIL46(4)](./img/5th_TIL46(4).png)
--| --|

![5th_TIL46(5)](./img/5th_TIL46(5).png)| ![5th_TIL46(6)](./img/5th_TIL46(6).png)
--| --|
...
글꼴, 맞춤(정렬, 글자 방향 등), 음영 설정 가능
![5th_TIL47(1)](./img/5th_TIL47(1).png)| ![5th_TIL47(2)](./img/5th_TIL47(2).png)
--| --|
...
![5th_TIL_Q1(1)](./img/5th_TIL_Q1(1).png)| ![5th_TIL_Q1(2)](./img/5th_TIL_Q1(2).png)| ![5th_TIL_Q1(3)](./img/5th_TIL_Q1(3).png)
--| --| --|

![5th_TIL_Q1(4)](./img/5th_TIL_Q1(4).png)
...
```
![5th_TIL_Q2(1)](./img/5th_TIL_Q2(1).png)| ![5th_TIL_Q2(2)](./img/5th_TIL_Q2(2).png)
--| --|

![5th_TIL_Q2(3)](./img/5th_TIL_Q2(3).png)| ![5th_TIL_Q2(4)](./img/5th_TIL_Q2(4).png)
--| --|

![5th_TIL_Q2(5)](./img/5th_TIL_Q2(5).png)
![5th_TIL_Q2(6)](./img/5th_TIL_Q2(6).png)
![5th_TIL_Q2(7)](./img/5th_TIL_Q2(7).png)
